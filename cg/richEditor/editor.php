<div class="editor_div">
  ...
  <div class="fore-wrapper"><i class='fa fa-font' style='color:#4286f4;'></i>
    <div class="fore-palette">
    </div>
  </div>
  <div class="back-wrapper"><i class='fa fa-font' style='background:#4286f4;'></i>
  ...
  <div class="h-wrapper">H
    <div class="header-pallete">
    </div>
  </div>
